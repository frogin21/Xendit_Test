...
public class Subtraction {
  ...
  public void TC_Subtraction() throws Exception {	  
    Subtraction.setUp();
    driver.get(baseUrl);
   ...
   //Screenshots frame with result=3
    ...
    ImageIO.write(logoImageScreenshot.getImage(),"png",new File("/Users/rachmat/Desktop/Subtraction_ACT.png"));
...
BufferedImage expectedImage = ImageIO.read(new File("/Users/rachmat/Desktop/Subtraction_ACT.png"));
    
Screenshot logoImageScreenshot2 = new AShot().takeScreenshot(driver);
ImageIO.write(logoImageScreenshot2.getImage(),"png",new File("/Users/rachmat/Desktop/Subtraction_EXP.png"));
