...
public class CE_RedButton {
  ...
  public void CEFunction() throws Exception {
	...
	//Screenshots frame with result=0  
	    ...
	    ImageIO.write(logoImageScreenshot.getImage(),"png",new File("/Users/rachmat/Desktop/CE_EXP.png"));
	  ...
	  ImageIO.write(logoImageScreenshot2.getImage(),"png",new File("/Users/rachmat/Desktop/CE_ACT.png"));
